...
def create_model(model_settings, model_architecture, model_size_info,
                 act_bits=None, act_max=None, save_act_value=False, save_act_dir=None):
  ...
  if model_architecture =='gru':
      ...
      return GRUModel(input_size, gru_units, layer_dim, num_classes, 
                      act_bits, act_max, save_act_value, save_act_dir)
